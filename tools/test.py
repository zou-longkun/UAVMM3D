...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/models/uavdet_3d/laa3d/centerdet.yaml', help='specify the config for training')
    parser.add_argument('--batch_size', type=int, default=None, required=False, help='batch size for training')
    parser.add_argument('--workers', type=int, default=0, help='number of workers for dataloader')
    parser.add_argument('--extra_tag', type=str, default='default', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='../output/models/uavdet_3d/laa3d/centerdet/default/ckpt/checkpoint_epoch_10.pth', help='checkpoint to start from')
