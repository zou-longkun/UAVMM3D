...
from tools.test_laam6d import repeat_eval_ckpt

def parse_config():
    parser = argparse.ArgumentParser(description='arg parser')
    parser.add_argument('--cfg_file', type=str, default='cfgs/models/uavdet_3d/laam6d/centerdet.yaml', help='specify the config for training')
